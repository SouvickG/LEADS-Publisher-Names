...
if __name__ == '__main__':
	# load data
	filename = "numeric-features-cv.csv"
	#filename = "numeric-features-cv-nostop.csv"
	...
	with open('feature-analysis-cv-noisbn.csv', "w", newline = '') as f:
	#with open('feature-analysis-cv-nostop-noisbn.csv', "w", newline = '') as f:
