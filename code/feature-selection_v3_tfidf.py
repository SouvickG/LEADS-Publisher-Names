...
if __name__ == '__main__':
	# load data
	#filename = "numeric-features-tfidf.csv"
	filename = "numeric-features-tfidf-nostop.csv"
	...
	#with open('feature-analysis-tfidf.csv', "w", newline = '') as f:
	with open('feature-analysis-tfidf-nostop.csv', "w", newline = '') as f:
